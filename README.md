...
- ⚡ **Interrupt-driven SPI — uses interrupt on the DOUT/RDY pin to read samples instead of polling mode
- 📥 **Complete register access and calibration** — full support for reading/writing all registers
